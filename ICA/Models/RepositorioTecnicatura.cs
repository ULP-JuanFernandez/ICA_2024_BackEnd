    ...
    public class RepositorioTecnicatura : RepositorioBase, IRepositorioTecnicatura
    {
        ...
        public IList<Tecnicatura> ObtenerTodos()
        {
            ...
            try
            {
                ...
                {
                    const string sql = @"SELECT Id, Nombre, Estado
                                 FROM Tecnicatura";
            ...
            catch (SqlException ex)
            {
                ...
                throw new ApplicationException("Se produjo un error al intentar obtener los tecnicatura.", ex);
            }
            catch (Exception ex)
            {
        ...
        public int Alta(Tecnicatura entidad)
        {
            ...
            const string sql = @"
            INSERT INTO Tecnicatura (Nombre, Estado)
        ...
        public int Modificacion(Tecnicatura entidad)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(connectionString))
                {
                    const string sql = "UPDATE Tecnicatura SET " +
            ...
            catch (SqlException ex)
            {
                ...
                throw new ApplicationException("Se produjo un error al intentar modificar la tecnicatura.", ex);
            }
            catch (Exception ex)
            {
        ...
        public int Baja(int id)
        {
            ...
            try
            {
                using (var connection = new SqlConnection(connectionString))
                {
                    string sql = @"DELETE FROM Tecnicatura WHERE Id = @id";
