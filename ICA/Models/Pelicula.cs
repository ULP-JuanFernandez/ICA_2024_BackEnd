...
namespace ICA.Models
{
    public class Pelicula
    {
        ...
        [Required(ErrorMessage = "El campo Realizador es obligatorio.")]
        ...
        [StringLength(1000, ErrorMessage = "La sinopsis no puede tener más de 1000 caracteres.")]
        public string? Sinopsis { get; set; } // Corresponde a la columna Sinopsis
        ...
        public List<Materia> Materias { get; set; } = new List<Materia>(); // Lista de objetos Materia
        [NotMapped]
