...
namespace ICA.Models
{
    public class Juego
    {
        ...
        [Required(ErrorMessage = "El campo Desarrollador es obligatorio.")]
        [StringLength(100, ErrorMessage = "El campo Desarrollador no puede tener más de 100 caracteres.")]
        public string Desarrollador { get; set; } // Corresponde a la columna Desarrollador
        [StringLength(100, ErrorMessage = "El campo Plataforma no puede tener más de 100 caracteres.")]
        public string? Plataforma { get; set; } // Corresponde a la columna Desarrollador
        ...
        public string? Link { get; set; } // Corresponde a la columna Link
